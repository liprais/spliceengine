...
import org.apache.hadoop.hbase.regionserver.compactions.ThroughputController;
import org.apache.hadoop.hbase.regionserver.compactions.NoLimitThroughputController;
        ...
        try {
            ...
            try {
                ...
                boolean finished = performCompaction(fd, scanner,  writer, smallestReadPoint, cleanSeqId,
                        new NoLimitThroughputController(), request.isMajor());
                if (!finished) {
                    writer.close();
