...
public class MemStoreFlushAwareScanner extends StoreScanner {
    ...
    public MemStoreFlushAwareScanner(HRegion region, HStore store, ScanInfo scanInfo, Scan scan,
    ...
    protected boolean isStopRow(Cell peek) {
        ...
        return (stopRow != null &&
                org.apache.hadoop.hbase.util.Bytes.compareTo(stopRow, 0, stopRow.length,
